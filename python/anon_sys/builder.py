...
def process(s: str, reserved_kw_unary: List[str] = ['']):
...
def buffered_replace(f: TextIOWrapper, start_sep: str = '{[{', end_sep: str = '}]}' , buffer_size = 2048, escape_chars: str = '[]', e_char: str = '\\',  **kwargs):
    """
